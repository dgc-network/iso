...
if (!class_exists('gemini_api')) {
    class gemini_api {
        ...
        function convert_content_to_styled_html($content) {
            ...
            $styled_html .= '<p><input type="text" id="drfat-title" value="'.'" class="text ui-widget-content ui-corner-all" /></p>';
            $styled_html .= '<p><textarea id="draft-content" rows="5" style="width:100%;">'.$content.'</textarea></p>';
