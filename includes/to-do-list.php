...
<head>
    ...
    <title>Dynamic Dialog Buttons</title>
...
<div id="custom-dialog" title="Dynamic Dialog">
    <p>This is a custom dialog with dynamic buttons.</p>
</div>
...
<table>
    ...
    <tbody>
        <tr>
            <td>1</td>
            <td>John Doe</td>
            <td class="interactive-bar">Click Me</td>
        </tr>
        <tr>
            <td>2</td>
            <td>Jane Smith</td>
...
<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
<script>
    // Optional: If you want to handle click events on the interactive bars
    $(document).ready(function () {
        $('.interactive-bar').click(function () {
            alert('Interactive bar clicked!');
