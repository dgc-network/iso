                    ...
                    switch (true) {
                        ...
                        case ($field_type=='_employees'):
                            ...
                            <?php if ($default_value=='me') {?>
                                ...
                                <input type="hidden" id="<?php echo esc_attr($field_name);?>" value="<?php echo json_encode(array($user->ID));?>" />
                                <?php /*
                                <input type="hidden" id="<?php echo esc_attr($field_name); ?>" value="<?php echo esc_attr(json_encode($field_value)); ?>" />
                                */?>
